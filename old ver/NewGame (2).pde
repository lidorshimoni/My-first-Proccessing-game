...
void setup() {
 ...
 gameon.setImage("Gameon.png");
 difflevel.setImage("diflevel.png");
 costume.setImage("shop.png");
...
void draw() {
  ...
  if (costumeflag==false && leaderboardflag==false && diflevelflag==false && menuflag==false){
...
void mouseClicked (){
  if(gameon.pointInShape(mouseX,mouseY)) {
   menuflag=false; 
  }
