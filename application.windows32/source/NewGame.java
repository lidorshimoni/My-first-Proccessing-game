...
if (pla.pointInShape(mouseX,mouseY)){
  if (shopflag==true){
    click.play();
    if (currentplayerskin>0){
    currentplayerskin=currentplayerskin-1;
    }
    if (currentplayerskin<=0){
      currentplayerskin=21;
    }
      player_skin[currentplayerskin].x =currentplayerskintext.x +120;
  player_skin[currentplayerskin].y = currentplayerskintext.y +70;
  player_skin[currentplayerskin].draw();
...
if (pra.pointInShape(mouseX,mouseY)){
  if (shopflag==true){
    click.play();
    if (currentplayerskin<21){
    currentplayerskin=currentplayerskin+1;
    }
    if (currentplayerskin>=21){
      currentplayerskin=0;
...
if (ela.pointInShape(mouseX,mouseY)){
  if (shopflag==true){
    click.play();
    if (currentenemyskin>0){
    currentenemyskin=currentplayerskin-1;
    }
    if (currentenemyskin<=0){
      currentenemyskin=21;
    }
